...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((Button) findViewById(R.id.session_event_page)).setOnClickListener(this);
...
//				startService(intent);
            ...
            case R.id.show_url_toasts:
                ...
                break;
            case R.id.session_event_page:
                startActivity(new Intent(this, ShowLogBasedOnSessionKey.class));
                break;
