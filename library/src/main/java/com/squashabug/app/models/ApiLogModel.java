...
public class ApiLogModel extends BaseModel implements Parcelable, Comparable<ApiLogModel> {
    ...
    @Override
    public int compareTo(ApiLogModel another) {
        return (another.sessionKey != null && this.sessionKey.equalsIgnoreCase(another.sessionKey)) ? 0 : 1;
    }
}
